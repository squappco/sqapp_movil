...
public class GameAdapter extends ArrayAdapter<Data> {
    Activity activity;
    public GameAdapter(Activity activity, ArrayList<Data> games) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Data game = getItem(position);
         ...
         ((TextView)convertView.findViewById(R.id.list_level)).setText(activity.getString(R.string.end_hour) + game.getEndTime());
